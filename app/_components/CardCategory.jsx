    ...
    return (
        <div className="group relative block">
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
                ...
                <p className="mt-1.5 text-pretty text-xs text-white font-manrope leading-5">
                    {description}
                </p>

                <Button
                    className="mt-3 inline-block bg-orange-500 transition-all ease-in-out rounded px-5 py-3 text-xs font-medium uppercase tracking-wide text-white"
                >
